...
function bs_enqueue_boilerplate_frontend_scripts() {
	...
	wp_register_script( 'bs-demo-frontend-script', SMPLFY_NAME_PLUGIN_URL . '/includes/js/frontend.js', array( 'jquery' ), null, true );
	wp_register_style( 'bs-demo-frontend-styles', SMPLFY_NAME_PLUGIN_URL . '/includes/css/frontend.css' );
